...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2023 a las 13:46:03
...
INSERT INTO `usuarios` (`id`, `nombre`, `apellidos`, `email`, `telefono`, `pass`, `pass2`, `administrador`, `provincia`, `municipio`) VALUES
(1, 'Fernando', 'Castellanos', 'fercasteprad@gmail.com', 667026260, 'MTIzNA==', 'MTIzNA==', 1, 'Madrid', 'Fuenlabrada'),
(2, 'Pedro', 'Lope', 'Carloslo@gmail.com', 667455467, 'MTIzNA==', 'MTIzNA==', 0, 'Madrid', 'LeganÃ©s'),
(3, 'Antonio', 'Perez', 'AntonioPe@gmail.com', 64578, 'MTIzNA==', 'MTIzNA==', 1, 'Ceuta', 'Ceuta'),
(4, 'Carlos', 'Castellanos Prada', 'feaprad@gmail.com', 667026260, 'MTIzNA==', 'MTIzNA==', 0, 'Madrid', 'Madrid'),
(5, 'Alicia', 'Rodas Martin', 'ali.rodass@gmail.com', 689455963, 'MTIzNA==', 'MTIzNA==', 0, 'Asturias', 'Oviedo');
...
--
ALTER TABLE `cuentas`
  MODIFY `idCuenta` int(255) NOT NULL AUTO_INCREMENT;
